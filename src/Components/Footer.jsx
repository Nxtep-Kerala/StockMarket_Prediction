                ...
                <div className="space-y-6 sm:max-w-md sm:mx-auto sm:text-center">
                    ...
                    <div className="items-center gap-x-3 space-y-3 sm:flex sm:justify-center sm:space-y-0">
                        <a 
                            ...
                            className="flex items-center justify-center gap-x-2 py-2.5 px-4 text-sm text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 duration-150 rounded-lg shadow-lg hover:shadow-none"
                        >
                            Let's get started
                            <svg
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    ...
                    <div className="flex items-center gap-x-6 text-gray-400 mt-6 sm:mt-0">
                        <a href="https://facebook.com" className="hover:text-indigo-400 transition-colors">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 48 48"><g clipPath="url(#a)"><path fill="currentColor" d="M48 24C48 10.745 37.255 0 24 0S0 10.745 0 24c0 11.979 8.776 21.908 20.25 23.708v-16.77h-6.094V24h6.094v-5.288c0-6.014 3.583-9.337 9.065-9.337 2.625 0 5.372.469 5.372.469v5.906h-3.026c-2.981 0-3.911 1.85-3.911 3.75V24h6.656l-1.064 6.938H27.75v16.77C39.224 45.908 48 35.978 48 24z" /></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h48v48H0z" /></clipPath></defs></svg>
                        </a>
                        <a href="https://x.com" className="hover:text-indigo-400 transition-colors">
                            <svg
                                className="w-6 h-6"
                                xmlns="http://www.w3.org/2000/svg"
